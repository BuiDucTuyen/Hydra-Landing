...
const Backer: React.FC = () => {
  return (
    <section className="bg-[#D4F3FF] py-16 animate-fadeInDown">
      <nav className="max-w-[1200px] mx-auto">
        <h1 className="text-[#270017] text-[48px] font-semibold mb-4 uppercase">
          Backers & Partners
        </h1>
        <h2 className=" text-ec-purple-700 text-center text-[18px] mb-12 font-normal">
          We are proud to be backed by crypto's leading venture capital firms,
          <br />
